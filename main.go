...
import (
	...
	"github.com/quay/clair-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8def12ab.projectquay.io",
	})
	if err != nil {
	...
	if err = (&controllers.ClairReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("Clair"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Clair")
		os.Exit(1)
	}
	if err = clairv1alpha1.SetupConfigWebhooks(mgr); err != nil {
