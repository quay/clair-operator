...
// kopium command: kopium --auto --derive Default --smart-derive-elision --filename -
...
#[kube(group = "gateway.networking.k8s.io", version = "v1", kind = "GRPCRoute", plural = "grpcroutes")]
#[kube(namespaced)]
